...
{
    public partial class _2BaoDamMac : Form
    {
        ...
        private void _2BaoDamMac_Load(object sender, EventArgs args)
        {
            // ===== FORM CONFIG =====
            ...
            btnPrev.Click += (s, args2) =>
            {
                new _1BaoDamAnUong().Show();
                this.Hide();
            };
            ...
            {
                new _3BaoDamONghi().Show();
                this.Hide();
            };
            pnlArrowRight.Controls.Add(btnNext);

            // ===== ADD CONTROLS (ĐÚNG THỨ TỰ) =====
